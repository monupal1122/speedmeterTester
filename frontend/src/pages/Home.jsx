              ...
              >
                {state === "ping" ? (
                  <div className="flex flex-col items-center gap-4">
                    <div className="w-32 h-32 rounded-full bg-gradient-to-br from-primary to-accent flex items-center justify-center shadow-lg shadow-primary/20">
                      <Activity className="text-black w-16 h-16 animate-pulse" />
                    </div>
                    <div className="text-center">
                      <div className="text-4xl font-bold text-primary mb-2">{metrics.ping.toFixed(0)} ms</div>
                      <div className="text-muted-foreground">Measuring Latency...</div>
                    </div>
                  </div>
                ) : (
                  <SpeedGauge
